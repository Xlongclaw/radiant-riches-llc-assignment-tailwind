...
const RatingContainer: React.FC<{ rating: number; ratingTag: string }> = ({
  ...
  return (
    <div className="bg-LIGHTBLUE flex flex-col items-center h-32 w-full rating-xl:w-4/5 rating-xxl:w-3/5 justify-center rounded-xl rating-md:rounded-b-xl mt-3 rating-md:-mt-3">
